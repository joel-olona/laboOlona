...
#[Route('/facebook/entry/contest')]
class ContestEntryController extends AbstractController
{
    #[Route('/', name: 'app_facebook_contest_entry_index', methods: ['GET'])]
    ...
    ): Response
    {
        ...
        return $this->render('facebook/contest_entry/index.html.twig', [
            'contest_entries' => $contestEntryRepository->paginateContestEntries($page),
        ]);
    }

    #[Route('/new', name: 'app_facebook_contest_entry_new', methods: ['GET', 'POST'])]
    public function new(Request $request, EntityManagerInterface $entityManager): Response
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            return $this->redirectToRoute('app_facebook_contest_entry_index', [], Response::HTTP_SEE_OTHER);
        }

        return $this->render('facebook/contest_entry/new.html.twig', [
            'contest_entry' => $contestEntry,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_facebook_contest_entry_show', methods: ['GET'])]
    public function show(ContestEntry $contestEntry): Response
    {
        return $this->render('facebook/contest_entry/show.html.twig', [
            'contest_entry' => $contestEntry,
        ]);
    }

    #[Route('/{id}/edit', name: 'app_facebook_contest_entry_edit', methods: ['GET', 'POST'])]
    public function edit(Request $request, ContestEntry $contestEntry, EntityManagerInterface $entityManager): Response
    {
        ...
        return $this->render('facebook/contest_entry/edit.html.twig', [
            'contest_entry' => $contestEntry,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_facebook_contest_entry_delete', methods: ['POST'])]
