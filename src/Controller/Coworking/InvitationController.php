...
#[Route('/coworking/invitation')]
#[IsGranted('ROLE_ADMIN')]
class InvitationController extends AbstractController
{
    #[Route('/', name: 'app_moderateur_invitation_index', methods: ['GET'])]
    ...
    #[Route('/new', name: 'app_moderateur_invitation_new', methods: ['GET', 'POST'])]
    public function new(
        Request $request, 
    ...
    ): Response
    {
        ...
        return $this->render('coworking/invitation/new.html.twig', [
            'invitation' => $invitation,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_moderateur_invitation_show', methods: ['GET'])]
    public function show(Invitation $invitation): Response
    {
        return $this->render('coworking/invitation/show.html.twig', [
            'invitation' => $invitation,
        ]);
    }

    #[Route('/{id}/edit', name: 'app_moderateur_invitation_edit', methods: ['GET', 'POST'])]
    ...
    ): Response
    {
        ...
        return $this->render('coworking/invitation/edit.html.twig', [
            'invitation' => $invitation,
            'form' => $form,
        ]);
    }

    #[Route('/{id}', name: 'app_moderateur_invitation_delete', methods: ['POST'])]
