...
namespace App\WhiteLabel\Entity\Client1\Finance;

use App\WhiteLabel\Entity\Client1\Candidate\TarifCandidat;
use App\WhiteLabel\Entity\Client1\Finance\Contrat;
use App\WhiteLabel\Repository\Client1\Finance\SimulateurRepository;
